...
export default function CommonSection({
  ...
  return (
    ...
    >
      ...
      >
        <p className="font-bold text-[40px] leading-[60px] md:text-start text-center">{title}</p>
        <p className="font-bold text-[18px] leading-[30px] md:text-start text-center">{content}</p>
      </div>
